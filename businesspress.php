...
class BusinessPress extends BusinessPress_Plugin {
  ...
  const VERSION = '1.6.1';
	...
	/**
	 * The instance of the BusinessPress class.
	 *
	 * @var BusinessPress
	 */
...
$businesspress = BusinessPress::_get_instance();

function BusinessPress() {
  return BusinessPress::_get_instance();
}

// These two have to load after the main class currently
